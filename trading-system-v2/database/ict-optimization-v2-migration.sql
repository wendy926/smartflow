...
-- 按照 DATABASE_SCHEMA_COMPARISON.md 中的建议分阶段实施
-- 执行前请先备份数据库！
...
ADD COLUMN IF NOT EXISTS multi_timeframe_aligned BOOLEAN DEFAULT TRUE COMMENT '多时间框架是否对齐';
...
SET 
  ...
  trailing_stop_active = COALESCE(trailing_activated, FALSE),

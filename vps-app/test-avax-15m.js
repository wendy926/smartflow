...
async function testAVAX15m() {
  try {
    ...
    const setupBreakdown = last15m.close < prev15m.low; // 按照strategy-v3.md：收盘价跌破setup candle低点
    ...
    console.log('跌破setup:', setupBreakdown, `(收盘价: ${last15m.close}, 前一根低点: ${prev15m.low})`);

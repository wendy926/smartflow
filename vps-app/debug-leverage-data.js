// debug-leverage-data.js
// 调试杠杆数据计算问题

const SmartFlowStrategyV3 = require('./modules/strategy/SmartFlowStrategyV3');

async function debugLeverageData() {
  try {
    console.log('🔍 开始调试杠杆数据计算...');
    
    const entryPrice = 0.33528;
    const stopLossPrice = 0.33464;
    const atr14 = 0.0005108844575036846;
    ...
    const minMargin = Math.ceil(100 / (maxLeverage * stopLossDistance));
    console.log(`最小保证金: ${minMargin}`);
...
// 运行调试
debugLeverageData().catch(console.error);
